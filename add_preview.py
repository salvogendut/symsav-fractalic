#!/usr/bin/env python3
"""Insert screensaver preview image into fractalic.sav at code offset 256."""
...
SAV_FILE = os.path.join(os.path.dirname(__file__), 'fractalic.sav')
